...
{
  "meta": {
    "pageTitle": "Mi Bautizo | Renata Zavala",
    "ogTitle": "",
    "ogDescription": "Acompáñanos a celebrar este día de fe y amor.",
    "publicUrl": ""
  },
  "event": {
    "template": "baptism",
    "label": "Mi Bautizo y Primer Añito",
    "age": "",
    "celebrantName": "Renata  Zavala ",
    "person1Name": "",
    "person2Name": "",
    "eventDate": "2026-09-12T15:00",
    "eventEnd": "2026-09-12T23:06",
    "calendarTitle": "Mi Bautizo Renata  Zavala",
    "timeZone": "America/Mexico_City",
    "eventLocation": "Nombre del lugar de recepción",
    "rsvpCountryCode": "52",
    "rsvpPhone": "56 3957 9908‬"
  },
  "theme": {
    "bgTop": "#f7fbfb",
    "bgMid": "#c9dfe2",
    ...
    "sectionTitle": "#55777c",
    "scriptColor": "#6f8f93",
    "timelineColor": "#b89b62",
    "timelineTimeColor": "#55777c",
    "timelineTitleColor": "#3e5f64",
    "timelineDescColor": "#657b7e",
    "timelineFont": "Cormorant Garamond",
    "locationTitleColor": "#55777c",
    "locationTimeColor": "#9a7b43",
    "locationPlaceColor": "#3e5f64",
    ...
    "backgroundImage": "media/fdbtz.png",
  ...
  "images": {
    ...
    "heroType": "image",
    "og": "media/1portada-ogv2.jpg",
    "story": "media/ichr.png",
  ...
  "audio": {
    "src": "media/julion-alvarez-y-su-norteno-banda---regalo-de-dios.mp3",
    "showControl": true
  },
  "story": {
    "title": "Un regalo de Dios",
    "paragraph1": "Hay regalos que llegan envueltos en papel y otros que llegan para cambiarte la vida para siempre.\n\nRenata es, para nosotros, un regalo de Dios.\nUna niña profundamente deseada, esperada con todo nuestro amor y que, desde antes de llegar, ya tenía un lugar enorme en nuestros corazones.\n\nCuando supimos que venía en camino, la noticia llenó de alegría a nuestra familia y a todas las personas que nos quieren. Su espera fue una etapa llena de ilusión, amor y muchas emociones compartidas; porque aunque todavía no conocíamos su carita, ya era inmensamente querida y esperada por todos.\n",
    "paragraph2": "Hoy, al verla crecer y tenerla entre nosotros, damos gracias a Dios por el maravilloso regalo de habernos permitido ser sus papás y por cada persona que ha formado parte de su historia desde el comienzo.\n\nPor eso queremos celebrar su vida y este momento tan especial rodeados de quienes han compartido nuestra alegría, nuestra ilusión y nuestro amor por ella.\n\nNos encantaría que nos acompañaras a celebrar a nuestra pequeña Renata, nuestro más bonito Regalo de Dios. 🤍✨",
    "showImage": true
  },
  "family": {
    "parentsEyebrow": "Con el amor de mis padres",
    "parentsNamesHtml": "Luis Alberto Zavala Sánchez<br>&amp;<br>Sandra R. Peña López<br><br>",
    "parentsGroups": [],
    "parentsInviteText": "Con mucha alegría te invitamos a compartir este día tan especial.",
    "godparentsEyebrow": "Y el cariño de mis padrinos",
    "godparentsNamesHtml": "Salvador López Acevedo<br>&amp;<br>Citlali Plata Segura<br><br>-<br><br>Arturo Moran Estrada<br>&amp;<br>Claudia López Acevedo<br><br>-<br><br>Gabriel Sierra Ontiveros<br>&amp;<br>Yolanda López Acevedo",
    "godparentsItems": []
  },
  "ceremony": {
    "title": "Ceremonia y Recepción",
    "time": "",
    "place": "Salon Jardin de eventos Garduño's",
    "showPlaceDetail": false,
    "placeDetail": "",
    "mediaMode": "photo",
    "iconSrc": "media/rcpbtz.jpg",
    "mapEmbed": "",
    "photoSrc": "media/rcpbtz.jpg",
    "mapLink": "https://maps.app.goo.gl/QF7mZfHDR9cHkX1JA"
  },
  "reception": {
    "title": "Recepción",
    "time": "",
    "place": "Nombre del lugar de recepción",
    "showPlaceDetail": false,
    "placeDetail": "",
    "mediaMode": "icon",
    ...
    "items": [
      {
        ...
        "desc": "Celebración del sacramento."
      },
      {
        "time": "",
        "title": "Recepción",
        "desc": "Convivencia con familia y amigos."
      }
    ]
  },
  "countdown": {
    "title": "Falta poco para mi Bautizo",
    "intro": "Cada día falta menos para compartir este momento lleno de fe y amor.",
    "style": "classic"
  },
  "dressCode": {
    "title": "Código de vestimenta",
    "value": "Estilo vaquero",
    "note": ""
  },
  "adultNotice": {
  ...
  "gifts": {
    ...
    "intro": "Tu presencia y tus buenos deseos son el regalo más importante. ",
    "option1Title": "Lluvia de sobres",
    "option1Copy": "Si lo prefieres, puedes acompañarnos con un sobre el día del evento.",
    "showOption1": false,
    "option2Title": "Regalo sorpresa",
    "option2Copy": "Si deseas tener un detalle, será recibido con mucho cariño.",
    "showOption2": true,
    "linksIntro": "También puedes apoyarte en estas opciones:",
    "showLinks": false,
    "links": []
  },
  "album": {
    "title": "Álbum de mi Bautizo",
    "copy": "Comparte las fotografías de este día tan especial.",
  ...
  "closing": {
    "note": "Gracias por acompañarme en este día lleno de fe y amor"
  },
  "brand": {
      ...
      if (options.observeVisibility === true && typeof IntersectionObserver === "function") {
        galleryVideoObserver ||= new IntersectionObserver((entries) => {
          entries.forEach((entry) => {
            ...
            const canAutoplay = video.dataset.autoplayWhenVisible === "true"
              && entry.intersectionRatio >= 0.65
              && !video.hidden
              && !video.ended
              && overlay.classList.contains("hidden")
              && !lightbox.classList.contains("show");
            if (canAutoplay && video.paused) video.play().catch(() => {});
          });
    ...
    function renderGalleryGrid() {
      ...
      galleryItems = items.map((src, index) => {
        ...
        button.appendChild(createGalleryMedia(item, { autoplayWhenVisible: item.type === "video" }));
        if (type === "video") {
